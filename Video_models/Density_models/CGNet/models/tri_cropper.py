...
class Model(nn.Module):
    def __init__(self, freeze_backbone=False, args=None) -> None:
        super().__init__()
    ...
    def forward(self, input):
        x = input["image_pair"] # [1, 6, 720, 1280]
        ...
        z1 = F.normalize(z1, dim=-1) # [1, 3, 720, 1280]
        z2 = F.normalize(z2, dim=-1) # [1, 27, 37632]
        y1 = F.normalize(y1, dim=-1) # [1, 12, 37632]
        y2 = F.normalize(y2, dim=-1) # [1, 10, 37632]
        return z1, z2, y1, y2
