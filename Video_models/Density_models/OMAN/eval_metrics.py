...
def main(args):
    with open(os.path.join(args.output_dir, "video_results_test.json"), "r") as f:
    ...
    for video_name in video_results:
        ...
        print('Video name: {}, Pred: {:.2f}, GT: {:.2f}, RMAE: {:.2f}'.format(video_name, pred_video_num, gt_video_num, (pred_video_num - gt_video_num) / gt_video_num))
        ...
        if scene_l[3] == 4:
            scene_dict['D4'].append(abs(gt_video_num-pred_video_num))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--label_dir', type=str, default='data/Sense/scene_label.txt')
