...
if __name__ == '__main__':
    ...
    parser.add_argument('--ckpt_dir', default='saved_qnrf/best.tar', type=str)
    ...
    # test loader
    datasets = Crowd(os.path.join(args.input_dir, 'test'), args.crop_size, args.downsample_ratio, is_gray=False, method='val')
