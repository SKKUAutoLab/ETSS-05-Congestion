...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', default='datasets/UCF-QNRF')
    parser.add_argument('--output_dir', default='datasets/UCF-Train-Val-Test')
    args = parser.parse_args()

    print('Processing dataset:', args.input_dir.split('/')[-1])
    min_size = 512
    max_size = 2048
    for phase in ['Train', 'Test']:
        ...
        if phase == 'Train':
            ...
            for sub_phase in sub_phase_list:
                sub_save_dir = os.path.join(args.output_dir, sub_phase)
            ...
            sub_save_dir = os.path.join(args.output_dir, 'test')
            if not os.path.exists(sub_save_dir):
                os.makedirs(sub_save_dir)
