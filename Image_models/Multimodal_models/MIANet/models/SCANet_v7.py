...
class SCANet(nn.Module):
    def __init__(self, load_weights = False):
        ...
        self.front1 = make_layers(self.front_feat)
        self.front2 = make_layers(self.front_feat)
        self.sca1 = SCA(512)
        self.sca2 = SCA(512)
        self.sca3 = SCA(512)
    ...
    def forward(self, x):
        ...
        x1 = self.front1(x1)
        x2 = self.front2(x2)
        o1_first, o2_first, conc1 = self.sca1(x1, x2)
        o1_second, o2_second, conc2 = self.sca2(o1_first, o2_first)
        o1_thir, o2_thir, conc3 = self.sca3(o1_second, o2_second)
        ...
        o = self.reg(o)
        o = F.interpolate(o, scale_factor=2, mode='bilinear') # [2, 1, 32, 32]
        return torch.abs(o)
...
class SCA(nn.Module):
    def __init__(self, channel):
        ...
        self.mlp = nn.Sequential(nn.Conv2d(channel*2, channel, 1, 1, bias=False))
...
class ChannelAttention(nn.Module):
    def __init__(self, channel=3, reduction=16):
        ...
        self.se = nn.Sequential(nn.Conv2d(channel, channel // reduction, 1, bias=False), nn.ReLU(),
