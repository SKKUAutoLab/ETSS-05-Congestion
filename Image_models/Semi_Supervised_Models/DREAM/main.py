...
parser.add_argument('--label-file-list', type=str, default='data/ShanghaiTech/file_lists/label_train.txt')
parser.add_argument('--unlabel-file-list', type=str, default='data/ShanghaiTech/file_lists/unlabel_train.txt')
parser.add_argument('--val-file-list', type=str, default='data/ShanghaiTech/file_lists/val.txt')
...
parser.add_argument('--train-unlabel-batch', type=int, default=16)
