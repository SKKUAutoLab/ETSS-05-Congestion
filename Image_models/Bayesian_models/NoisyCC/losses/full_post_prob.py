...
class Full_Post_Prob(Module):
    def __init__(self, sigma, alpha, c_size, stride, background_ratio, use_background, add=False, minx=1e-6, ratio=0.6):
