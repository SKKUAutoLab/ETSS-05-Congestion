...
class VGG(nn.Module):
    def __init__(self, features, down=8, cls=False, o_cn=1, final='abs'):
    ...
    def forward(self, x): # [1, 3, 512, 512]
        ...
        if self.down < 16:
            x = F.interpolate(x, scale_factor=2) # [1, 512, 64, 64]
        x = self.reg_layer(x) # [1  1, 64, 64]
        if self.final == 'abs':
            x = torch.abs(x) # [1, 1, 64, 64]
...
cfg = {'C': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512], 'D': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 'M', 512, 512, 512, 'M', 512, 512, 512],
       'E': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512, 'M', 512, 512, 512, 512], 'F': [64, 64, 'M', 128, 128, 'M', 256, 256, 256, 256, 'M', 512, 512, 512, 512]}
