...
def loc_gt_make(mode='test', args=None):
    ...
    for idx, img_id in enumerate(img_ids):
        ...
        if idx != -1:
            ...
            with open(os.path.join(args.output_dir, mode + '_gt_loc_x2.txt'), 'a') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--type_dataset', type=str, default='SHHB')
    parser.add_argument('--input_dir', type=str, default='data/ShanghaiTech')
    parser.add_argument('--output_dir', type=str, default='data/ShanghaiTech/part_B')
