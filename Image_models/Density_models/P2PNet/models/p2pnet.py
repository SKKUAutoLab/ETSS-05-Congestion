...
class Decoder(nn.Module):
    ...
    def forward(self, inputs):
        ...
        P5_x = self.P5_2(P5_x) # [32, 256, 8, 8]
        P4_x = self.P4_1(C4)
        P4_x = P5_upsampled_x + P4_x
        P4_upsampled_x = self.P4_upsampled(P4_x)
        P4_x = self.P4_2(P4_x) # [32, 256, 16, 16]
        P3_x = self.P3_1(C3)
        P3_x = P3_x + P4_upsampled_x
        P3_x = self.P3_2(P3_x) # [32, 256, 32, 32]
...
class P2PNet(nn.Module):
    ...
    def forward(self, samples: NestedTensor): # [32, 3, 128, 128]
        ...
        output_coord = regression + anchor_points # [32, 1024, 2]
        output_class = classification # [32, 1024, 2]
