...
class AutoScale(nn.Module):
    def __init__(self, load_weights=False):
        ...
        self.conv1 = nn.Sequential(nn.Conv2d(3, 64, 3, padding=35), nn.ReLU(inplace=True),
                                   nn.Conv2d(64, 64, 3, padding=1), nn.ReLU(inplace=True))
        self.conv2 = nn.Sequential(nn.MaxPool2d(2, stride=2, ceil_mode=True), nn.Conv2d(64, 128, 3, padding=1), nn.ReLU(inplace=True),
                                   nn.Conv2d(128, 128, 3, padding=1), nn.ReLU(inplace=True))
        self.conv3 = nn.Sequential(nn.MaxPool2d(2, stride=2, ceil_mode=True), nn.Conv2d(128, 256, 3, padding=1), nn.ReLU(inplace=True),
                                   nn.Conv2d(256, 256, 3, padding=1), nn.ReLU(inplace=True),
                                   nn.Conv2d(256, 256, 3, padding=1), nn.ReLU(inplace=True))
        self.conv4 = nn.Sequential(nn.MaxPool2d(2, stride=2, ceil_mode=True), nn.Conv2d(256, 512, 3, padding=1), nn.ReLU(inplace=True),
                                   nn.Conv2d(512, 512, 3, padding=1), nn.ReLU(inplace=True),
                                   nn.Conv2d(512, 512, 3, padding=1), nn.ReLU(inplace=True))
        self.conv5 = nn.Sequential(nn.MaxPool2d(2, stride=1, padding=1, ceil_mode=False), nn.Conv2d(512, 512, 3, padding=2, dilation=2),
                                   nn.ReLU(inplace=True), nn.Conv2d(512, 512, 3, padding=2, dilation=2), nn.ReLU(inplace=True),
                                   nn.Conv2d(512, 512, 3, padding=2, dilation=2), nn.ReLU(inplace=True))
        self.cd1 = nn.Sequential(nn.Conv2d(64, 24, 3, padding=1), nn.BatchNorm2d(24))
        self.cd2 = nn.Sequential(nn.Conv2d(128, 24, 3, padding=1), nn.BatchNorm2d(24))
        self.cd3 = nn.Sequential(nn.Conv2d(256, 24, 3, padding=1), nn.BatchNorm2d(24))
        self.cd4 = nn.Sequential(nn.Conv2d(512, 24, 3, padding=1), nn.BatchNorm2d(24))
        self.cd5 = nn.Sequential(nn.Conv2d(512, 24, 3, padding=1), nn.BatchNorm2d(24))
        self.rd5 = nn.Sequential(nn.Conv2d(24, 8, 1), nn.BatchNorm2d(8))
        self.rd4 = nn.Sequential(nn.Conv2d(32, 8, 1), nn.BatchNorm2d(8))
        self.rd3 = nn.Sequential(nn.Conv2d(32, 8, 1), nn.BatchNorm2d(8))
        self.rd2 = nn.Sequential(nn.Conv2d(32, 8, 1), nn.BatchNorm2d(8))
