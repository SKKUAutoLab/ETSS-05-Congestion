...
parser.add_argument('--jhu_pairs', default=None, type=int)
...
parser.add_argument('--dataset_name', default='ShanghaiTechA', type=str)
parser.add_argument('--model_name', default='CSRNet', type=str)
parser.add_argument('--start_step', default=0, type=int)
parser.add_argument('--end_step', default=500, type=int, help="ShanghaiTechA step = 1000 | ShanghaiTechB step = 500 | UCF-QNRF step = 300 | JHU step = 70")
...
if dataset_name == 'JHU_Combine':
    data = JHU_combine(vis_mode=VIS_MODE,
                        ...
                        split_ratio=split_ratio, split_num=split_num, down_sample=down_sample, compare_nums=compare_nums)
    data_compare = JHU_compare(down_sample=down_sample, compare_nums=compare_nums)
elif dataset_name == 'JHU_NumCombine':
    data = JHU_num_combine(vis_mode=VIS_MODE,
                        add_err=ADD_LOSS_MODE,rank_err=RANK_LOSS_MODE,
                        split_ratio=split_ratio, split_num=split_num, down_sample=down_sample, compare_nums=compare_nums, pairs=pairs)
    data_compare = JHU_compare(down_sample=down_sample, compare_nums=compare_nums)
    ...
    data_compare = ShanghaiTech_compare(down_sample=down_sample, is_A=False)
    data_val = ShanghaiTech_eval(vis_mode=VIS_MODE,down_sample=down_sample, is_A=False)
elif dataset_name == 'UCF-QNRF_AllCombine':
    data = UCF_allcombine(vis_mode=VIS_MODE,
                        add_err=ADD_LOSS_MODE,rank_err=RANK_LOSS_MODE,
                        split_ratio=split_ratio, split_num=split_num, down_sample=down_sample)
    data_compare = UCF_compare(down_sample=down_sample)
    data_val = UCF_eval(vis_mode=VIS_MODE,down_sample=down_sample)
elif dataset_name == 'UCF-QNRF_Combine':
    data = UCF_combine(vis_mode=VIS_MODE,
                        add_err=ADD_LOSS_MODE,rank_err=RANK_LOSS_MODE,
                        split_ratio=split_ratio, split_num=split_num, down_sample=down_sample)
    data_compare = UCF_compare(down_sample=down_sample)
    data_val = UCF_eval(vis_mode=VIS_MODE,down_sample=down_sample)
