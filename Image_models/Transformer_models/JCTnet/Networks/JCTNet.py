...
class SwinIR(nn.Module):
    ...
    def __init__(self, img_size=64, patch_size=1, in_chans=3,
        ...
        self.conv_first = VGG()
        self.conv_two = nn.Conv2d(512, embed_dim, 3, 1, 1)
        ...
        ################################ 3, Counting regression ################################
        self.conv_before_upsample = nn.Sequential(nn.Conv2d(embed_dim, num_feat, 3, 1, 1),
                                                  nn.BatchNorm2d(num_feat),
                                                  nn.LeakyReLU(inplace=True))
        self.conv_last = nn.Sequential(nn.Conv2d(num_feat, num_feat//2, 3, 1, 1),
...
def Net(**kwargs):
    model = SwinIR(img_size=(256, 256), window_size=4, depths=[8, 8, 8, 8],
...
if __name__ == '__main__':
    ...
    #                embed_dim=256, num_heads=[8, 8, 8, 8], mlp_ratio=2)
    # print(model)
