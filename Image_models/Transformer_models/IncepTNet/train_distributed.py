...
def main(args):
    if args['dataset'] == 'jhu':
        ...
        train_file = './npydata/sha_train.npy'
        test_file = './npydata/sha_test.npy'
    ...
    if args['distributed']:
        ...
        path = './save_file_jhu_64*192_66/log_file/' + time.strftime("%Y%m%d_%H%M%S", time.localtime(time.time()))
        args['save_path'] = path
