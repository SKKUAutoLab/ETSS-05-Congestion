...
class SHA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        img, points,bboxs = load_data((img_path, gt_path))
...
def build(image_set, args):
    ...
    if image_set == 'train':
        train_set = SHA(args.input_dir, train=True, transform=transform, flip=True)
        return train_set
    elif image_set == 'val':
        val_set = SHA(args.input_dir, train=False, transform=transform)
        return val_set
    else:
        print('This image set does not exist')
