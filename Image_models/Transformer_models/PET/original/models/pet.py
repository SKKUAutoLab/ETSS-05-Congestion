...
from .transformer import window_partition, build_decoder, build_encoder
...
class PET(nn.Module):
    def __init__(self, backbone, num_classes, args=None):
        ...
        self.quadtree_splitter = nn.Sequential(nn.AvgPool2d((context_h, context_w), stride=(context_h ,context_w)), nn.Conv2d(hidden_dim, 1, 1), nn.Sigmoid())
    ...
    def train_forward(self, samples, features, pos, **kwargs):
        ...
        losses = self.compute_loss(outputs, criterion, targets, epoch)
        return losses
