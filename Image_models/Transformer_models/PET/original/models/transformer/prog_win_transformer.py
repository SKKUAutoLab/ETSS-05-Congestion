...
class WinDecoderTransformer(nn.Module):
    ...
    def decoder_forward_dynamic(self, query_feats, query_embed, memory_win, pos_embed_win, mask_win, **kwargs):
        tgt = query_feats
    ...
    def forward(self, src, pos_embed, mask, pqs, **kwargs):
        ...
        if 'test' in kwargs:
            ...
            hs = self.decoder_forward_dynamic(query_feats, query_embed, memory_win, pos_embed_win, mask_win, **kwargs)
            return hs
        else:
